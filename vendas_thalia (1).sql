...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Maio-2022 às 19:03
...
(1, 'TV Led', '2000.00', 5, 'TV de última geração', 5),
...
(4, 'iPad Mini', '5000.00', 8, 'Tablet Apple com tela retina display de 4k, memória interna de 64GB, acesso ao iCloud.', 3),
...
(12, ' Celular k60s', '2500.00', 2, 'Celular ótimo para estudar, para trabalho e para o lazer!', 4);
